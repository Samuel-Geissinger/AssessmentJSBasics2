...
//CODE HERE
const canWeDeliver = zipCode => deliveryAreaZipCodes.filter(e => e === zipCode).length > 0 ? `You're in our delivery zone!`: `Sorry, we can't deliver to that address`;
// console.log(canWeDeliver(8525));
...
// CODE HERE
const canWeDeliver2 = zipCode => deliveryAreaZipCodes.includes(zipCode) ? `You're in our delivery zone!`: `Sorry, we can't deliver to that address`;
// console.log(canWeDeliver2(8525));
//////////////////PROBLEM 3////////////////////
/* 
